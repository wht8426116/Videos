      ...
      <tbody>
        <c:forEach items="${pageInfo.list}" var="speaker" varStatus="status">
            <tr>
	          ...
	          <td><a href="${pageContext.request.contextPath}/speaker/edit?id=${speaker.id}"><span class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
	...
	<div class="container">
		<div class="navbar-right">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<li>
						<a href="${pageContext.request.contextPath}/speaker/showList?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
					<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" >
						<li><a href="${pageContext.request.contextPath}/speaker/showList?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
					</c:forEach>


					<li>
						<a href="${pageContext.request.contextPath}/speaker/showList?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">
